...
describe('MoviCore', () => {
    ...
    it('should authenticate requests', () => {
        ...
        $httpBackend.whenGET(matchAny, expectedHeader).respond(200);
        $httpBackend.expectPOST(matchAny, matchAny, expectedHeader).respond(200);
        $httpBackend.expectPUT(matchAny, matchAny, expectedHeader).respond(200);
        $httpBackend.expectDELETE(matchAny, expectedHeader).respond(200);
